...
def main():
    ...
    parser.add_argument("--video_path", required=True, help="The path where the videos for labelling reside")
    parser.add_argument("--label", required=False, help="The label for the videos. This applies only for videos with no metadata")
    parser.add_argument("--output_path", required=True, help="The path to save the labels")
    ...
    if args.d_name == "celeb":
        ...
        if os.path.isfile(full_path):
            ...
            video_labeller = VideoLabeller(args.video_path, args.label, args.output_path)
